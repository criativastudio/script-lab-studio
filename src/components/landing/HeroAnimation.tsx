          ...
          <div className="grid grid-cols-2 gap-3">
            <div className="h-20 rounded-lg bg-primary/5 border border-primary/10 p-3">
              ...
              <div className="space-y-1.5">
                <div className="h-2 w-full rounded bg-muted/8" />
                <div className="h-2 w-3/4 rounded bg-muted/6" />
              </div>
            </div>
            <div className="h-20 rounded-lg bg-[hsl(260_80%_65%/0.04)] border border-[hsl(260_80%_65%/0.1)] p-3">
              <div className="h-2 w-16 rounded bg-[hsl(260_80%_65%/0.2)] mb-2" />
              <div className="space-y-1.5">
                <div className="h-2 w-full rounded bg-muted/8" />
                <div className="h-2 w-2/3 rounded bg-muted/6" />
              </div>
            </div>
          </div>
        </div>
