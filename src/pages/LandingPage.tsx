      ...
      <section className="relative min-h-screen flex items-center justify-center bg-background overflow-hidden pt-16">
        ...
        <div className="relative z-10 mx-auto max-w-5xl px-4 text-center">
          ...
          <motion.h1
            ...
            className="font-display text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-light leading-[1.05] tracking-tight text-foreground mb-8 max-w-3xl mx-auto"
          >
            Crie Ideias de Conteudos <span className="text-gradient-primary">Para as Redes Sociais em Segundos</span>
          </motion.h1>
      ...
      <section id="solucao" className="relative py-16 md:py-24 px-4">
        <div className="mx-auto max-w-5xl text-center relative z-10">
          ...
          >
            ...
            <p className="mx-auto mb-16 max-w-2xl text-muted-foreground text-base md:text-lg font-light leading-relaxed">
      ...
      <section id="planos" className="relative py-16 md:py-24 px-4">
        ...
        <div className="mx-auto max-w-6xl text-center relative z-10">
          ...
          >
            ...
            <h2 className="font-display text-5xl font-light md:text-4xl mb-6 tracking-tight">
